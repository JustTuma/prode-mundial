...
export default async function SocialPage() {
  ...
  const [feedRes, wallRes] = await Promise.all([
    ...
    supabase.from('predictions')
      .select('*, profiles!predictions_user_id_fkey(id, username, avatar_url), matches(home_team, away_team, home_score, away_score, status, home_team_flag, away_team_flag)')
